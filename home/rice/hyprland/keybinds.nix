{
  ...
  entries =
    [
      ...
      (binding "bind" "Launchers" "${mod}, D" "exec, discord" "Open Discord")
      ...
      (binding "bind" "Windows" "${mod}, T" "togglegroup" "Toggle window group")
      (binding "bind" "Windows" "${modshift}, G" "changegroupactive" "Switch active grouped window")
      (binding "bind" "Windows" "${mod}, V" "togglefloating" "Toggle floating")
      (binding "bind" "Windows" "${mod}, F11" "fullscreen" "Toggle fullscreen")
      (binding "bind" "Windows" "${mod}, G" "exec, hyprctl dispatch lockactivegroup toggle" "Lock active group")
      (binding "bind" "Windows" "${mod}, M" "exec, hyprctl dispatch toggleorientation" "Toggle group orientation")
      (binding "bind" "Windows" "${mod}, U" "exec, hyprctl dispatch focusurgentorlast" "Focus urgent or last window")
      ...
      (binding "bind" "Special workspaces" "${mod}, A" "exec, toggle-special-dp2 social" "Toggle social special workspace")
      (binding "bind" "Special workspaces" "${modshift}, A" "exec, move-special-dp2 social" "Move window to social special workspace")
      (binding "bind" "Special workspaces" "${mod}, W" "exec, toggle-special-dp2 tools" "Toggle tools special workspace")
      (binding "bind" "Special workspaces" "${modshift}, W" "exec, move-special-dp2 tools" "Move window to tools special workspace")
      (binding "bind" "Special workspaces" "${mod}, Z" "exec, toggle-special-dp2 scratchpad" "Toggle scratchpad")
      (binding "bind" "Special workspaces" "${modshift}, Z" "exec, move-special-dp2 scratchpad" "Move window to scratchpad")
      (binding "bind" "Special workspaces" "${mod}, O" "exec, toggle-obs-special" "Toggle OBS special workspace")
      (binding "bind" "Special workspaces" "${modshift}, O" "exec, move-special-dp2 obs" "Move window to OBS special workspace")
      (binding "bind" "Special workspaces" "${mod}, F12" "exec, foot --app-id=scratchpad -e tmux" "Open scratchpad terminal")
      ...
      (binding "bind" "Quickshell" "${mod}, X" "global, quickshell:powerMenu" "Open power menu")
      ...
      (binding "bind" "Quickshell" "${modshift}, S" "exec, ${ipc} tools screenshotSave" "Select screenshot area and save")
